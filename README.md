...
### My Process
1. Structure and set up Ruby folders/project appropriately.
2. Create copies of original files to refer back to.
3. Run the program in IRB.
4. Write and pass tests for all requirements.
5. Read and understand original code
6. Refactor into more readable, DRY, clean and logical code.
7. Extract code into various methods in order to follow SRP.
